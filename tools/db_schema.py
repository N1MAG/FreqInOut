...
NETS_TABLES: Dict[str, TableDef] = {
    ...
    "local_operator_reports": TableDef(
        name="local_operator_reports",
        db=NETS_DB,
        description="Timestamped local voice/mesh/manual operator reports normalized for message-intelligence categories.",
        ddl="""
    ...
    "sitrep_state_rollup": TableDef(
        name="sitrep_state_rollup",
        db=NETS_DB,
        description="Derived per-state latest SitRep summary for fast map overlays and report-group filtering.",
        ddl="""
