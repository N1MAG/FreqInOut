...
class FldigiNetControlTab(QWidget):
    ...
    def _build_ui(self):
        ...
        self.selected_radio_summary_label = QLabel("Selected radio drives FLDigi / SSB net-control actions.")
        ...
        suspend_row.addWidget(self.hold_duration_combo)
    ...
    def _update_copy_buttons_state(self) -> None:
        ...
        self.copy_main_btn.setStyleSheet(
            button_style("eligible_success", theme) if main_has else button_style("muted", theme)
        )
        self.copy_late_btn.setStyleSheet(
            button_style("eligible_info", theme) if late_has else button_style("muted", theme)
        )
    ...
    def _refresh_station_context_ui(self) -> None:
        ...
        if context is None:
            ...
            self.selected_radio_summary_label.setText("Selected radio drives FLDigi / SSB net-control actions.")
            return
    ...
    def _on_selected_radio_combo_changed(self, _index: int) -> None:
        ...
        try:
            ...
            log.debug("FldigiNetControl: failed changing selected radio: %s", exc)
