            ...
            with open(fn, newline="", encoding="utf-8") as f:
                ...
                for row in reader:
                    ...
                    data = {
                        ...
                        "group1": lower_row.get("group1", "").strip(),
                        "group2": lower_row.get("group2", "").strip(),
                        "group3": lower_row.get("group3", "").strip(),
                        "group_role": (lower_row.get("group role") or lower_row.get("group_role") or "").strip(),
