...
def _get_config_dir():
    """
    Determine a writable config/log directory using the shared runtime profile root.
    Fallbacks remain local/temp if the shared helper cannot produce a writable path.
    """
    candidates = []
    try:
